...
BEGIN_MESSAGE_MAP(CDataStruct1App, CWinApp)
...
CDataStruct1App::CDataStruct1App()
{
	// 支持重新启动管理器
...
// 唯一的一个 CDataStruct1App 对象

CDataStruct1App theApp;


// CDataStruct1App 初始化

BOOL CDataStruct1App::InitInstance()
{
